//! Task coordinator for managing complex multi-step task execution
...
pub(super) const MAX_DECOMPOSITION_DEPTH: usize = 5;

/// Maximum number of subtasks per task
pub(super) const MAX_SUBTASKS_PER_TASK: usize = 10;
